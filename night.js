...
let watch = {
  ...
  special: [
    { key: "★원거리 피해", val: "+20%", per: 0.0773067 },
    { key: "★근거리 피해", val: "+20%", per: 0.0773067 },
    { key: "★스킬 재사용 속도", val: "+10%", per: 0.0773067 },
    { key: "★힘", val: "+10%", per: 0.0773067 },
    { key: "★민첩", val: "+10%", per: 0.0773067 },
    { key: "★지능", val: "+10%", per: 0.0773067 },
    { key: "★체력", val: "+25%", per: 0.0773067 },
    { key: "★활력", val: "+25%", per: 0.0773067 },
    { key: "★버프 효과", val: "+25%", per: 0.0773067 },
    { key: "★치명타 피해", val: "+25%", per: 0.0773067 },
    { key: "★모든 속성 저항", val: "+25%", per: 0.0773067 },
    { key: "★우두머리 추가 피해", val: "+25%", per: 0.0498753 },
    { key: "★모든 속성 강화", val: "+25%", per: 0.0498753 },
    { key: "★피해 감소", val: "+25%", per: 0.0498753 },
  ],
};
